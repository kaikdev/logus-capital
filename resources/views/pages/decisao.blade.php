            ...
            <div class="decisao">
                ...
                <div class="conteudo">
                    ...
                    <div class="area-itens">
                        ...
                        data-title="{{ __('decisao.item1.title') }}"
                        data-text1="{{ __('decisao.item1.text1') }}"
                        data-text2="{{ __('decisao.item1.text2') }}"
                        data-text3="{{ __('decisao.item1.text3') }}">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    {!! __('decisao.item1.title') !!}
                                </p>
                            </div>

                            <p>
                                {!! __('decisao.item1.text1') !!}
                            </p>
                        </div>

                        <div class="item animate" data-animate="fade" 
                        data-title="{{ __('decisao.item2.title') }}"
                        data-text1="{{ __('decisao.item2.text1') }}"
                        data-text2="{{ __('decisao.item2.text2') }}"
                        data-text3="{{ __('decisao.item2.text3') }}">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    {!! __('decisao.item2.title') !!}
                                </p>
                            </div>

                            <p>
                                {!! __('decisao.item2.text1') !!}
                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item3.title') }}"
                        data-text1="{{ __('decisao.item3.text1') }}"
                        data-text2="{{ __('decisao.item3.text2') }}"
                        data-text3="{{ __('decisao.item3.text3') }}"
                        data-text4="{{ __('decisao.item3.text4') }}">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    {!! __('decisao.item3.title') !!}
                                </p>
                            </div>

                            <p>
                                {!! __('decisao.item3.text1') !!}
                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item4.title') }}"
                        data-text1="{{ __('decisao.item4.text1') }}"
                        data-text2="{{ __('decisao.item4.text2') }}"
                        data-text3="{{ __('decisao.item4.text3') }}">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    {!! __('decisao.item4.title') !!}
                                </p>
                            </div>

                            <p>
                                {!! __('decisao.item4.text1') !!}
                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item5.title') }}"
                        data-text1="{{ __('decisao.item5.text1') }}"
                        data-text2="{{ __('decisao.item5.text2') }}"
                        data-text3="{{ __('decisao.item5.text3') }}">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    {!! __('decisao.item5.title') !!}
                                </p>
                            </div>

                            <p>
                                {!! __('decisao.item5.text1') !!}
                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item6.title') }}"
                        data-text1="{{ __('decisao.item6.text1') }}"
                        data-text2="{{ __('decisao.item6.text2') }}"
                        data-text3="{{ __('decisao.item6.text3') }}">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    {!! __('decisao.item6.title') !!}
                                </p>
                            </div>

                            <p>
                                {!! __('decisao.item6.text1') !!}
                            </p>
                        </div>
                    </div>
