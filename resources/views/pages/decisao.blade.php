            ...
            <div class="decisao">
                ...
                <div class="conteudo">
                    ...
                    <div class="area-itens">
                        ...
                        data-title="{{ __('decisao.item1.title2') }}"
                        data-text1="{{ __('decisao.item1.text2') }}"
                        data-text2="{{ __('decisao.item1.text3') }}">
                            <div class="top">
                                <div class="icone">
                        ...
                        data-title="{{ __('decisao.item2.title2') }}"
                        data-text1="{{ __('decisao.item2.text2') }}"
                        data-text2="{{ __('decisao.item2.text3') }}">
                            <div class="top">
                                <div class="icone">
                        ...
                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item3.title2') }}"
                        data-text1="{{ __('decisao.item3.text2') }}"
                        data-text2="{{ __('decisao.item3.text3') }}"
                        data-text3="{{ __('decisao.item3.text4') }}">
                            <div class="top">
                                <div class="icone">
                        ...
                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item4.title2') }}"
                        data-text1="{{ __('decisao.item4.text2') }}"
                        data-text2="{{ __('decisao.item4.text3') }}">
                            <div class="top">
                                <div class="icone">
                        ...
                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item5.title2') }}"
                        data-text1="{{ __('decisao.item5.text2') }}"
                        data-text2="{{ __('decisao.item5.text3') }}">
                            <div class="top">
                                <div class="icone">
                        ...
                        <div class="item animate" data-animate="fade"
                        data-title="{{ __('decisao.item6.title2') }}"
                        data-text1="{{ __('decisao.item6.text2') }}"
                        data-text2="{{ __('decisao.item6.text3') }}">
                            <div class="top">
                                <div class="icone">
