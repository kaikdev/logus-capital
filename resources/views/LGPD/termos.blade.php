...
@section('content')
    <section class="page-terms">
        <div class="content">
            ...
            <ul class="menu">
                <a href="#section_1" class="section_1">{{ __('lgpd.menu.privacidade') }}</a>
                <a href="#section_2" class="section_2">{{ __('lgpd.menu.termos') }}</a>
                <a href="#section_3" class="section_3">{{ __('lgpd.menu.cookies') }}</a>
                <a href="#section_4" class="section_4">{{ __('lgpd.menu.cancelar') }}</a>
            </ul>
            ...
            <main>
                <div class="content">
                    <div class="wrapper">
                        ...
                        {{-- SECTION 4 (FORMULÁRIO FICA NO BLADE) --}}
                        <article id="section_4">
                            <h1>{{ __('lgpd.section_4.title') }}</h1>
                            <p>{{ __('lgpd.section_4.subtitle') }}</p>
                                ...
                                <div class="col-2">
                                    <div class="group-input">
                                        <label for="nome-terms">
                                            {{ __('lgpd.section_4.labels.nome') }}
                                        </label>
                                        <input id="nome-terms" type="text" name="nome" value="{{ old('nome') }}">
                                    </div>
                                </div>

                                <div class="group-input">
                                    <label for="email-terms">
                                        {{ __('lgpd.section_4.labels.email') }}
                                    </label>
                                    <input id="email-terms" type="email" name="email" value="{{ old('email') }}" required>
                                </div>

                                <div class="group-input">
                                    <label for="telephone-terms">
                                        {{ __('lgpd.section_4.labels.telefone') }}
                                    </label>
