...
<head>
    ...
    <meta property="og:image" content="{{ asset('img/logus-capital.png') }}"/>
    <meta property="twitter:image" content="{{ asset('img/logus-capital.png') }}"/>
...
<body>
    ...
    <div id="modal-exit" class="all-modal">
        ...
        <div class="modal">
            ...
            <div class="wrapper">
                <div class="logo">
                    <img src="{{ asset('img/logus-capital.png') }}" alt="Logo - {{ getItem('client') }}" title="Logo - {{ getItem('client') }}">
                </div>
