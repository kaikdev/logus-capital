            ...
            <div class="decisao">
                ...
                <div class="conteudo">
                    ...
                    <div class="area-itens">
                        <div class="item on animate" data-animate="fade" 
                        data-title="<?php echo e(__('decisao.item1.title')); ?>"
                        data-text1="<?php echo e(__('decisao.item1.text1')); ?>"
                        data-text2="<?php echo e(__('decisao.item1.text2')); ?>"
                        data-text3="<?php echo e(__('decisao.item1.text3')); ?>">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    <?php echo __('decisao.item1.title'); ?>

                                </p>
                            </div>

                            <p>
                                <?php echo __('decisao.item1.text1'); ?>

                            </p>
                        </div>

                        <div class="item animate" data-animate="fade" 
                        data-title="<?php echo e(__('decisao.item2.title')); ?>"
                        data-text1="<?php echo e(__('decisao.item2.text1')); ?>"
                        data-text2="<?php echo e(__('decisao.item2.text2')); ?>"
                        data-text3="<?php echo e(__('decisao.item2.text3')); ?>">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    <?php echo __('decisao.item2.title'); ?>

                                </p>
                            </div>

                            <p>
                                <?php echo __('decisao.item2.text1'); ?>

                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="<?php echo e(__('decisao.item3.title')); ?>"
                        data-text1="<?php echo e(__('decisao.item3.text1')); ?>"
                        data-text2="<?php echo e(__('decisao.item3.text2')); ?>"
                        data-text3="<?php echo e(__('decisao.item3.text3')); ?>"
                        data-text4="<?php echo e(__('decisao.item3.text4')); ?>">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    <?php echo __('decisao.item3.title'); ?>

                                </p>
                            </div>

                            <p>
                                <?php echo __('decisao.item3.text1'); ?>

                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="<?php echo e(__('decisao.item4.title')); ?>"
                        data-text1="<?php echo e(__('decisao.item4.text1')); ?>"
                        data-text2="<?php echo e(__('decisao.item4.text2')); ?>"
                        data-text3="<?php echo e(__('decisao.item4.text3')); ?>">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    <?php echo __('decisao.item4.title'); ?>

                                </p>
                            </div>

                            <p>
                                <?php echo __('decisao.item4.text1'); ?>

                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="<?php echo e(__('decisao.item5.title')); ?>"
                        data-text1="<?php echo e(__('decisao.item5.text1')); ?>"
                        data-text2="<?php echo e(__('decisao.item5.text2')); ?>"
                        data-text3="<?php echo e(__('decisao.item5.text3')); ?>">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    <?php echo __('decisao.item5.title'); ?>

                                </p>
                            </div>

                            <p>
                                <?php echo __('decisao.item5.text1'); ?>

                            </p>
                        </div>

                        <div class="item animate" data-animate="fade"
                        data-title="<?php echo e(__('decisao.item6.title')); ?>"
                        data-text1="<?php echo e(__('decisao.item6.text1')); ?>"
                        data-text2="<?php echo e(__('decisao.item6.text2')); ?>"
                        data-text3="<?php echo e(__('decisao.item6.text3')); ?>">
                            <div class="top">
                                <div class="icone">
                                ...
                                <p class="title">
                                    <?php echo __('decisao.item6.title'); ?>

                                </p>
                            </div>

                            <p>
                                <?php echo __('decisao.item6.text1'); ?>

                            </p>
                        </div>
                    </div>
                    
                    <div id="conteudo-item">
                        <h4 class="animate" data-animate="fade">
                        </h4>

                        <div class="texts animate" data-animate="left">
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const items = document.querySelectorAll('.area-itens .item');
            ...
            items.forEach((item, index) => {
                item.addEventListener('click', () => {
                    ...
                    if (window.innerWidth < 900) {
                        const content = document.getElementById('conteudo-item');
            ...
            function updateContent(index) {
                ...
                content.querySelector('h4').innerHTML =
                ...
                while (item.dataset[`text${i}`]) {
                    texts.push(`<p>${item.dataset[`text${i}`]}</p>`);
                    i++;
                }

                content.querySelector('.texts').innerHTML = texts.join('');
            }
        });
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home2/logus670/public_html/novo/resources/views/pages/decisao.blade.php ENDPATH**/ ?>