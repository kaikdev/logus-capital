...
<?php $__env->startSection('title', __('main.header.link_2')); ?>
<?php $__env->startSection('description-seo', $metatag->description ?? getItem('client')); ?>

<?php $__env->startSection('head'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/diferenciais.css')); ?>">
        ...
        <div class="content">
            <div class="diferenciais">
                <div class="title-default animate" data-animate="fade">
                    ...
                    <h2>
                        <?php echo __('diferenciais.subtitle1'); ?>
                ...
                <div class="conteudo">
                    <div class="item-def animate" data-animate="top" id="mini1">
                        ...
                        <div class="text">
                            ...
                            <a href="#" class="link" target="_blank">
                                <?php echo __('diferenciais.item1.link'); ?>
                    ...
                    <div class="item-full" id="full1">
                        <div class="text">
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <?php echo __('diferenciais.link-2'); ?>
                        ...
                        <div class="area-img">
                            <img src="<?php echo e(asset('img/diferenciais/diferenciais-1-interna.webp')); ?>" alt="<?php echo __('diferenciais.item1.title'); ?>">
                    ...
                    <div class="item-full" id="full4">
                        ...
                        <div class="area-img">
                            <img src="<?php echo e(asset('img/diferenciais/diferenciais-2-interna.webp')); ?>" alt="<?php echo __('diferenciais.item2.title'); ?>">
                    ...
                    <div class="item-def animate" data-animate="top" id="mini3">
                        <div class="text">
                            ...
                            <a href="#" class="link" target="_blank">                            
                                <?php echo __('diferenciais.item3.link'); ?>
                        ...
                        <div class="area-img">
                            <img src="<?php echo e(asset('img/home/diferenciais-3.webp')); ?>" alt="<?php echo __('diferenciais.item3.title'); ?>">
                        </div>
                    </div>
                    <div class="item-full" id="full3">
                        ...
                        <div class="area-img">
                            <img src="<?php echo e(asset('img/diferenciais/diferenciais-3-interna.webp')); ?>" alt="<?php echo __('diferenciais.item3.title'); ?>">
                    ...
                    <div class="item-def animate" data-animate="top" id="mini2">
                        ...
                        <div class="text">
                            ...
                            <a href="#" class="link" target="_blank">
                                <?php echo __('diferenciais.item4.link'); ?>
                    ...
                    <div class="item-full" id="full2">
                        ...
                        <div class="area-img">
                            <img src="<?php echo e(asset('img/diferenciais/diferenciais-4-interna.webp')); ?>" alt="<?php echo __('diferenciais.item4.title'); ?>">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('.item-full a').forEach(btn => {
                if (!btn.textContent.toLowerCase().includes('')) return;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home2/logus670/public_html/novo/resources/views/pages/diferenciais.blade.php ENDPATH**/ ?>